                            ...
                            list.map((item, i) => (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className="row m-0 mb-1">
                                                <div className="col px-0" >
                                                    <Form.Control placeholder="Desc" size="sm" 
                                                    className='ex m-0 p-0 bg-dark border-dark text-secondary' 
                                                    defaultValue={"Desc"}/>
                                                </div>
                                                <div className="col-1 p-0" style={{textAlign:'right'}} >
                                                    <Form.Control placeholder="sets" size="sm" 
                                ...
                                :
                                    <div className='row' key={item.id}>
                                        <Form.Control placeholder="Title" size="md" /* TITLE */
                                        ...
                                        <div className='remove-btn col-3'>
                                            <button className='btn btn-outline-none p-0' type="button" /* REMOVE */
                                                onClick={() => RemoveDay()}>
